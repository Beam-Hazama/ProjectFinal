                ...
                <div v-for="user in usersStore.users" :key="user.id"
                    ...
                    <div class="relative h-30 w-full overflow-visible bg-slate-200">
                        ...
                        <div class="absolute top-4 right-4 flex flex-col gap-2 items-end z-20">
                            <span :class="[
                                ...
                                user.Status === 'active' ? 'bg-emerald-400 text-white' : 'bg-red-400 text-white'
                            ]">
                                {{ user.Status }}
                            </span>
                        </div>
                    ...
                    <div class="pt-10 px-6 py-2 flex-grow flex flex-col">
                        ...
                        <div class="space-y-3 bg-slate-50/50 p-4 rounded-2xl">
                            <div class="flex items-center gap-3 text-sm">
                                ...
                                <span class="text-slate-600 leading-tight">{{ user.Phone }}</span>
                            </div>
                            <div class="flex items-center gap-3 text-sm">
                                <div class="bg-white p-1.5 rounded-lg shadow-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-slate-500" fill="none"
                    ...
                    <div class="px-6 pb-6 pt-2 flex gap-3">
                        ...
                        <button @click="toggleUserStatus(user)" :class="[
                            ...
                            (user.Status) === 'active' ? 'bg-amber-50 text-amber-600 hover:bg-amber-500 hover:text-white' : 'bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white'
                        ]">
                            <svg v-if="user.Status === 'active'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

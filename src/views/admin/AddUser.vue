        ...
        <div class="min-h-screen p-6 md:p-8 font-sans bg-slate-50/50">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <div class="flex gap-3">
                    ...
                    <button @click="checkSaveUser" :disabled="!isFormValid || formStore.isLoading"
                    ...
                    <div class="p-8 lg:col-span-1 bg-slate-50/30 flex flex-col items-center">
                        ...
                        <div class="flex flex-col items-center gap-5 w-full max-w-xs">
                            <div
                                ...
                                <img v-if="formStore.userData.ImageUrl" :src="formStore.userData.ImageUrl"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="form-control">
                                    ...
                                    <select v-model="formStore.userData.Restaurant"
                                        ...
                                        <option v-for="res in formStore.restaurants" :key="res.id"
                                            :value="res.RestaurantName">{{ res.RestaurantName }}</option>
                                    </select>
                                </div>
                                <div class="form-control">
                                    <label class="label"><span

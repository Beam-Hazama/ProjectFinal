                    ...
                    <div v-for="(item, index) in order.receivedItems" :key="index" class="flex justify-between items-center group">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-[10px] text-slate-400 font-medium">{{ item.RestaurantName }}</span>
                                <span v-if="item.Note" class="text-[10px] text-slate-400 font-normal italic whitespace-pre-wrap break-words mt-0.5">{{ item.Note }}</span>
                            </div>
                        </div>

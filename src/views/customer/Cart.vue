...
<template>
  <div
              ...
              <div>
                <div class="flex justify-between items-start">
                  <div class="flex-grow min-w-0">
                    ...
                    <p v-if="cart.RestaurantName || cart.Restaurant"
                      class="text-[11px] text-slate-500 font-medium mt-0.5 truncate w-full">{{ cart.RestaurantName ||
                      cart.Restaurant }}</p>
                    <div v-if="cart.Note"
                      class="text-[11px] text-slate-400 font-normal mt-0.5 italic whitespace-pre-wrap break-words">
                      {{ cart.Note }}
                    </div>
                  </div>
    ...
    <dialog ref="confirmModal" class="modal">
      <confirm-order :qrId="cartStore.qrId" @close-modal="closeConfirmModal"></confirm-order>
    </dialog>
    <BottomNavigation />
  </div>
</template>

...
<template>
  <div class="w-full min-h-screen p-4 pb-56 space-y-5 bg-center bg-no-repeat animate-bg bg-gradient-to-br from-blue-50 to-purple-50 font-sans">    
    ...
    <div class="bg-white/80 backdrop-blur-md shadow-xl border border-white/50 rounded-2xl p-5">
      ...
      <TransitionGroup name="list" tag="div" class="divide-y divide-slate-100">
        <div v-for="(cart, index) in cartStore.item" :key="cart.cartItemId" class="group relative py-6 first:pt-0 last:pb-0 transition-all duration-300">
              ...
              <div>
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex flex-col items-end flex-shrink-0">
                    ...
                    <div v-if="cart.basePrice && cart.basePrice > cart.Price" class="text-xs text-slate-400 line-through mt-0.5">
    ...
    <div class="fixed bottom-20 left-0 w-full px-4 z-50">
      <div @click="showConfirmModal" class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-1 rounded-2xl shadow-xl shadow-blue-500/40 transform hover:-translate-y-1 active:scale-95 transition-all duration-300 cursor-pointer group"
        ...
        <div class="flex justify-between items-center px-6 py-4 bg-transparent rounded-xl border border-white/20">
          <div class="flex flex-col">
            ...
            <span class="text-xl font-black">{{ formatPrice(cartStore.totalPrice) }}<span class="text-sm font-bold ml-1">บาท</span></span>
          </div>
          <div class="flex items-center gap-2 bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm group-hover:bg-white group-hover:text-blue-600 transition-all">

        ...
        <div class="p-6 font-sans">
            <div class="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                ...
                <div class="flex gap-3">
                    ...
                    <button @click="checkAddMenu(MenuData)" class="btn border-none w-32 rounded-xl transition-all duration-300 font-bold"
                        :class="[
                                    ...
                                    <div v-for="(group, gIndex) in MenuData.OptionGroups" :key="'group-' + gIndex" class="relative pb-6 border-b border-slate-100 last:border-0 last:pb-0 group">
                                        ...
                                        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-4 pr-10 items-end">
                                            ...
                                            <div class="form-control">
                                                ...
                                                <div class="relative">
                                                    <input type="number" min="1" class="input input-bordered w-full pr-16 focus:input-primary bg-slate-50 border-slate-200"

...
const checkSave = () => formStore.save(null, router, route);
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                    ...
                                    <div class="form-control md:col-span-2">
                                        ...
                                        <select class="select select-bordered w-full focus:select-primary bg-slate-50 border-slate-200 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed" v-model="MenuData.RestaurantName" :disabled="true">
                                    ...
                                    <div v-for="(group, gIndex) in MenuData.OptionGroups" :key="'group-' + gIndex" class="relative pb-6 border-b border-slate-100 last:border-0 last:pb-0 group">
                                        ...
                                        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-4 pr-10 items-end">
                                            <div class="form-control">
                                                ...
                                                <input type="text" class="input input-bordered w-full focus:input-primary bg-slate-50 border-slate-200" v-model="group.GroupName" />
                                            </div>
                                            <div class="form-control">
                                                <label class="label"><span class="label-text font-medium text-slate-600">จำนวนที่เลือกได้</span></label>
                                                <div class="relative">
                                                    <input type="number" min="1" class="input input-bordered w-full pr-16 focus:input-primary bg-slate-50 border-slate-200" v-model="group.MaxChoices" @keypress="!/^\d$/.test($event.key) && $event.preventDefault()" />

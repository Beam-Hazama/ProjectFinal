...
const ICONS = {
  ...
  history: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
...
const menus = [
  ...
  { name: 'Poster', routeName: 'Admin Poster', icon: ICONS.poster },
      ...
      <aside class="w-72 min-h-full bg-white shadow-xl flex flex-col border-r border-slate-100">
        ...
        <div class="h-20 flex items-center px-6 border-b border-slate-100 shrink-0">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-xl font-extrabold text-slate-800 tracking-tight">Admin<span class="text-blue-600">.</span>
              </h1>

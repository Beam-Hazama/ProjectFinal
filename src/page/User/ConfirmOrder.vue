...
<template>
  <div
    class="modal-box p-0 w-11/12 max-w-md bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(79,70,229,0.3)] overflow-hidden font-sans border border-slate-100 relative">

    <div
      class="absolute top-0 right-0 w-64 h-64 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 -translate-y-1/2 translate-x-1/2 pointer-events-none">
    </div>
    ...
    <div
      class="pb-6 px-6 bg-slate-50 mt-4 rounded-t-[2.5rem] shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)] relative z-20">

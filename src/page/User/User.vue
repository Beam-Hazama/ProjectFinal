      ...
      <div class="flex items-center justify-between px-4 py-3">
        <div class="flex flex-col">
          ...
          <div class="flex gap-2 mt-0.5">
            <span class="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded text-slate-600">ชั้น 2</span>
            <span class="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded text-slate-600">ตึก A</span>
          </div>
        </div>

  ...
  >
    <div class="flex justify-between items-start mb-2">
      <div class="flex items-center gap-2">
        ...
        <div>
          <h1
            class="text-3xl font-black tracking-tight text-blue-600 drop-shadow-md"
          >
            MY CART
          </h1>
    ...
    >
      <div
        class="flex justify-between items-center mb-4 border-b border-blue-100 pb-4"
      >
        <span class="text-lg font-bold text-gray-700 mx-3"
          >รายการอาหารที่สั่ง</span
        >
      </div>

      <div
        v-if="!cartStore.item || cartStore.item.length === 0"
        ...
        >
          <div class="flex justify-between items-center">
            <div class="flex items-center gap-3 overflow-hidden">
              ...
              <div class="min-w-0">
                <div class="font-bold text-gray-800 text-lg truncate">
                  {{ cart.Name }}
                  <span class="text-xs text-gray-400">(฿{{ cart.Price }})</span>
                </div>
                <button
            ...
            <div class="flex items-center justify-between px-4 py-3 bg-white">
              ...
              <button
                class="p-2 ml-8 rounded-full text-slate-400 hover:bg-red-50 hover:text-red-500 transition"
              >
                <Trach />
              </button>
            </div>
    ...
    <div
      class="bg-white/90 backdrop-blur-lg shadow-xl border border-white/60 rounded-2xl p-5 space-y-3"
    >
      ...
      <div
        class="flex justify-between text-red-500 bg-red-50 p-2 rounded-lg border border-red-100"
      >
        <span class="flex items-center gap-1"
          ><span class="text-xs">🏷️</span>ส่วนลด</span
        >
        <span></span>
      </div>
      ...
      <div class="flex justify-between items-end">
        ...
        <span
          class="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500"
        >
    ...
    <div
      class="fixed bottom-6 left-0 w-full px-4 z-50"
      ...
      >
        ...
        >
          <div class="flex flex-col">
            <span
              class="text-xs text-blue-100 font-light uppercase tracking-wider"
              >ยอดชำระ</span
            >
            <span class="text-xl font-bold"
              >{{ cartStore.summaryPrice }}
              <span class="text-sm font-bold">บาท </span>
            </span>
          </div>
          <div
